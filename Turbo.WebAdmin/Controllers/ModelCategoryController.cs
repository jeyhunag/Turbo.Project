...
namespace Turbo.WebAdmin.Controllers
{
    ...
    {
        private readonly IGenericService<ModelCategoryDto, ModelCategory> _service;


        public ModelCategoryController(IGenericService<ModelCategoryDto, ModelCategory> service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(ModelCategoryDto itemDto)
        {
        ...
        [HttpPost]
        public IActionResult Update(ModelCategoryDto itemDto)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public IActionResult Delete(ModelCategoryDto itemDto)
        {
