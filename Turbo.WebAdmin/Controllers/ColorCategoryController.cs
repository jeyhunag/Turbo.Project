...
namespace Turbo.WebAdmin.Controllers
{
    ...
    {
        private readonly IGenericService<ColorCategoryDto, ColorCategory> _service;


        public ColorCategoryController(IGenericService<ColorCategoryDto, ColorCategory> service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<IActionResult> Create(ColorCategoryDto itemDto)
        {
        ...
        [HttpPost]
        public IActionResult Update(ColorCategoryDto itemDto)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        public IActionResult Delete(ColorCategoryDto itemDto)
        {
