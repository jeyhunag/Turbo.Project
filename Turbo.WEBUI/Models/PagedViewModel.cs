...
namespace Turbo.WEBUI.Models
{
                 ...
                 where T : class
    {
        ...
        public PagedViewModel(IEnumerable<Product> query, int pageIndex, int pageSize)
        {
            this.PageSize = pageSize;


            this.TotalCount = query.Count();
            this.Items = (IEnumerable<T>?)query.Skip((pageIndex > 0 ? pageIndex - 1 : 0) * pageSize)
                .Take(pageSize)
                .ToList();
